...
LammpsObject::LammpsObject(string selector, string inputFolder, LoggerPtr logger)
{
    ...
    std::map<string, string> selectorToFile = {
    ...
    string inputFilePath = inputFolder + selectorToFile[selector];
