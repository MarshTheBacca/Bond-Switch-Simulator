...
class Network:
    ...
    def generate_ring_crds(self, rings, av_ring_size):
        ...
        #self.ring_crds = np.vstack(self.ring_crds)
#        print(len(self.ring_crds))
#        ring_crds = self.ring_crds[0]
#        for i in range(1,len(self.ring_crds)):
#            ring_crds = np.vstack((ring_crds, ring_crds[i]))
        self.ring_crds = np.array(self.ring_crds)
#        self.ring_crds = ring_crds
